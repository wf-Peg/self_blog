(function (e) {
    ...
    for (var i = 0; i < r && !window.requestAnimationFrame; ++i) {
        ...
        window.cancelAnimationFrame = window[n[i] + "CancelAnimationFrame"] || window[n[i] +
    ...
    e.fn.sakura = function (t, n) {
        ...
        if (typeof t === "undefined" || t === "start") {
            ...
            var a = function () {
                ...
                var l = "fall " + f + "s linear 0s 1" + ", " + t + " " + ((f > 30 ? f : 30) - 20 + u(0, 20)) +
                    "s linear 0s infinite" + ", " + i + " " + u(2, 4) + "s linear 0s infinite";
                ...
                c.prefixedEvent("AnimationEnd", function () {
                    ...
                    if ((e.inArray(t.animationName, n.blowAnimations) != -1 || e.inArray(t.animationName, n.swayAnimations) != -
                            1) && !s(this)) {
                        e(this).remove()
                    }
                }).css({
                    "-webkit-animation": l,
                    animation: l,
                    "border-radius": u(n.maxSize, n.maxSize + Math.floor(Math.random() * 10)) + "px " + u(1, Math.floor(
                        p / 4)) + "px",
                    height: h + "px",
